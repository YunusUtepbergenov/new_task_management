        ...
        >
            ...
            >
                    ...
                    <div class="fa-whats-new-header-left">
                        ...
                        <div>
                            ...
                            <span class="fa-whats-new-subtitle">
                                {{ trans_choice('announcements.count', $unseen->count(), ['count' => $unseen->count()]) }}
                            </span>
                        </div>
                    </div>
                    <button
                ...
                <div class="fa-whats-new-body">
                    @foreach ($unseen as $announcement)
                        <article wire:key="fa-{{ $announcement->id }}" class="fa-whats-new-card">
