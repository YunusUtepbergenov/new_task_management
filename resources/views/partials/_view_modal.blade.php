                            ...
                            <div class="col-lg-8 col-xl-9">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <button type="button" class="btn btn-purple" style="width: 100%">Начать выполнение</button>
                                            </div>
                                            <div class="col-sm-4">
                                                <button type="button" class="btn btn-danger" style="width: 100%">Завершить</button>
                                            </div>
                                            <div class="col-sm-4">
                                ...
                                <div class="project-task">
                                    <ul class="nav nav-tabs nav-tabs-top nav-justified mb-0">
                                        <li class="nav-item"><a class="nav-link active" href="#all_tasks" data-toggle="tab" aria-expanded="true">Комментарии</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#pending_tasks" data-toggle="tab" aria-expanded="false">История</a></li>
                                    </ul>
                                ...
                                <div class="card project-user">
                                    ...
                                    <div class="card-body">
                                        <h6 class="card-title m-b-20">
                                            Соисполнители
                                            <button type="button" class="float-right btn btn-primary btn-sm" data-toggle="modal" data-target="#assign_user"><i class="fa fa-plus"></i> Добавить</button>
                                        </h6>
                                        <ul class="list-box">
                                            <li>
                                                <a href="profile.html">
